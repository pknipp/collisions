...
export default {
  ...
  data() {
    return {
      ...
      dots: [
        {id: 1, diameter: 200, Rxyz: [], rxyz: [800, 400, 0], vxyz: [200, 300, 1000]},
        {id: 2, diameter: 200, Rxyz: [], rxyz: [1100, 100, 700],vxyz: [-200, 0, -200]},
        {id: 3, diameter: 200, Rxyz: [], rxyz: [600, 200, 150], vxyz: [-100, -90, 20]},
        {id: 4, diameter: 200, Rxyz: [], rxyz: [800, 500, 200], vxyz: [50, 50, -30]},
        {id: 5, diameter: 200, Rxyz: [], rxyz: [1100, 100, 100],vxyz: [-40, -80, 50]},
        {id: 6, diameter: 200, Rxyz: [], rxyz: [1200, 300, 600],vxyz: [80, -300, 30]},
        {id: 7, diameter: 200, Rxyz: [], rxyz: [500, 700, 100], vxyz: [-100, 200, 300]},
        {id: 8, diameter: 200, Rxyz: [], rxyz: [700, 700, 300], vxyz: [100, 90, 10]},
        {id: 9, diameter: 200, Rxyz: [], rxyz: [1100, 500, 500],vxyz: [-50, -50, 100]},
        {id: 10,diameter: 200, Rxyz: [], rxyz: [900, 100, 600], vxyz: [40, -80, -200]},
      ],
      numCol: 0,
      dims: [1600, 800, 800],
      running: false
